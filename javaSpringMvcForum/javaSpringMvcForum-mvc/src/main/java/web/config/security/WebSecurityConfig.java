...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter
{
    ...
    protected void configure(HttpSecurity http) throws Exception
    {
        http.authorizeRequests()
                ...
                .antMatchers("/forum/{forumId}/newThread.htm").permitAll()
                .antMatchers("/forum/{forumId}/thread/{threadId}.htm").permitAll()
                .antMatchers("/forum/{forumId}/thread/{threadId}/new.htm").permitAll()
                ...
                .antMatchers(HttpMethod.POST,"/forum/**.htm").permitAll()
                .antMatchers(HttpMethod.POST,"/forum/{forumId}/thread.htm").permitAll()
                .antMatchers(HttpMethod.POST,"/forum/{forumId}/thread/**.htm").permitAll()
